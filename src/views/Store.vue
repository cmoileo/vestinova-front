  ...
  <div class="bg-gray-100">
    ...
    >
      ...
      <div class="relative z-10">
        <h1 class="text-5xl font-bold uppercase">Notre Boutique</h1>
        <p class="text-lg mt-4">Découvrez tous nos produits pour Homme et Femme.</p>
      </div>
    </section>
    ...
    <section class="new-collection text-center flex-grow px-4 md:px-8 lg:px-16 py-6">
      <h2 class="text-4xl font-bold mb-8">Tous Nos Produits</h2>
